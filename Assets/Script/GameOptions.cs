...
public class GameOptions : MonoBehaviour {
	...
	void OnGUI(){
		...
		GUI.DrawTexture (new Rect (300, 140, _titleSound.width, _titleSound.height), _titleSound);
		_soundVolume = GUI.HorizontalSlider (new Rect (300, 250, Screen.width - 490 - 50, 20), _soundVolume, 0.0f, 1.0f);
